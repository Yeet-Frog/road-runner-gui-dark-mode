...
class MainPanel : JPanel() {
    ...
    private var trajectoryConfig: TrajectoryConfig? = null
        ...
        set(value) {
            trajectoryListPanel.background = Color.DARK_GRAY
            trajectoryInfoPanel.background = Color.DARK_GRAY
            pathEditorPanel.background = Color.DARK_GRAY
            if (value != null) {
    ...
    init {
        ...
        configPanel.background = Color.DARK_GRAY
        layout = BorderLayout()
        ...
        upperContent.background = Color.DARK_GRAY
        print(upperContent.background)
        upperContent.layout = BoxLayout(upperContent, BoxLayout.LINE_AXIS)

        upperContent.add(trajectoryListPanel)
        /*(
                JPanel().apply {
        ...
        trajContent.background = Color.DARK_GRAY
        trajectoryGraphPanel.background = Color.DARK_GRAY
        ...
        statusPanel.background = Color.GRAY
        ...
        upperContent.background = Color.DARK_GRAY
        upperRightTabbedPane.background = Color.GRAY

        lowerTabbedPane.background = Color.GRAY
    ...
    fun close(): Boolean {
        return if (trajectoryListPanel.dirty) {
            val result = JOptionPane.showConfirmDialog(this, "The saving feature has been deprecated.")
            when (result) {
